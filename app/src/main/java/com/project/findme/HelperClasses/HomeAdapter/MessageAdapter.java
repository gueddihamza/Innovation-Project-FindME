...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.GroupViewHolder> {
    ...
    public MessageAdapter(ArrayList<GroupMessage> groupMessages) {
    ...
    public int getItemViewType(int position) {
        ...
        if(groupMessages.get(position).getSenderUID().equals(user.getUid())){
